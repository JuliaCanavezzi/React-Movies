...
export function Landing() {
  return (
    <div className="min-h-screen w-full overflow-hidden bg-zinc-950 selection:bg-green-400 selection:text-emerald-950">
      ...
      <main className="container mx-auto grid min-h-[80vh] grid-cols-1 items-center gap-12 p-6 lg:grid-cols-2">
        <div className="z-10 order-2 flex flex-col items-start text-left lg:order-1">
          ...
          <div className="mt-8 flex w-full flex-col gap-4 sm:w-auto sm:flex-row">
            ...
            <Link
              to="/list-movies"
              className="flex h-12 items-center justify-center gap-2 rounded-full border-2 border-zinc-700 bg-transparent px-8 font-bold text-base text-white transition-all hover:border-green-400 hover:text-green-400 active:scale-95"
            >
              Ver Catálogo
            </Link>
          </div>
        ...
        <div className="perspective-1000 relative order-1 h-full min-h-[400px] w-full lg:order-2">
          ...
          <div className="mask-image:linear-gradient(to_bottom,transparent,black_20%,black_80%,transparent) grid scale-110 grid-cols-3 gap-4 p-4 opacity-80 [transform:rotateX(20deg)_rotateZ(-20deg)_skewY(5deg)]">
            <div className="-mt-12 flex animate-pulse flex-col gap-4 duration-[3000ms]">
              <img
                src={posters[0]}
            ...
            <div className="mt-12 flex animate-pulse flex-col gap-4 duration-[4000ms]">
              <img
                src={posters[4]}
                className="rounded-xl object-cover shadow-2xl shadow-emerald-900/50 ring-1 ring-white/10"
                alt="Poster 5"
